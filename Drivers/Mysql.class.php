...
/**
 * Class DBMysql  to manage database  using mysql function
 * @Package Database
 * @category DBMysql
 * @version: 0.1
...
/**
 * DBMysql::getConfig() -Function To get Config selected Array 
 * @return mixed 
 */
...
/**
 * DBMysql::prepareConfig() -Function To get Config By Selected Active Db
 * @return mixed
 */
...
/**
 * DBMysql::setprefix() -Function to set table prefix
 * @return mixed
 */
...
/**
 * DBMysql::checkConfig() -Function To Check argument schema
 * @return bool
 */
...
/**
 *  DBMysql::__construct() -Function To initialize configuration and active DB 
...
/**
 * DBMysql::__destruct() Object destroyed 
 * @return bool
 */
...
/**
 * DBMysql::connect() Connect Database 
 * @return bool
 */
...
$this->Dblink=mysql_connect($Host,$UserDb,$PassDb,$this->multipleConnection()); 
...
/**
 * DBMysql::Err() function Error Show
...
/**
 * DBMysql::multipleConnection()  active multiple Database connection 
 * @return bool
 */
private function multipleConnection(){
if($this->link_database!="default"){
return true;
} else {
return false;
}
...
/**
 * DBMysql::Quote() - prepare string to inserted or updated in the database
 * @param string $string
 * @return string
 */
...
/**
 * DBMysql::clean() -   Clean data .:recommended filter Data through PHP Code:
 * <code>
 * <?php
...
/**
 * Mysql::SetCharset()  set Charset for database
 * @return bool
 */
...
if($c['Charset']!=''){
$val=$c['Charset'];
mysql_set_charset("$val",$this->Dblink); 
mysql_query("SET CHARACTER SET $val",$this->Dblink); 
mysql_query("SET NAMES $val",$this->Dblink);  
return true; 
}
}
}
...
$rowcount=mysql_query($sql,$this->Dblink) or $this->Err($sql);
...
/**
 * DBMysql::insertid() get Last ID insert
 * @return int
 */
...
/**
 * DBMysql::fetchRow() Fetch One record
 * @param  string $table  table name
 * @param  string  $con   where condition
...
$rs=mysql_query($sql,$this->Dblink) or $this->Err($sql);
...
/**
 * DBMysql::Delete() Delete Row function From Db
...
/**
 * DBMysql::save() -   Save  data into DB
...
/**
 * DBMysql::Fetch() Fetch Rows From table
...
/**
 * DBMysql::loadCSS() Load CSS for pagination
 * @return string
 */
...
/**
 * DBMysql::pagination()   pagination database record
...
/**
 * DBMysql::FormatSize()   function To Format size  
...
/**
 * DBMysql::databaseSize()     Size of database  
 * @return string
 */
...
$rec=mysql_query($sql,$this->Dblink);
...
/**
 * DBMysql::backUp()   backUp database 
...
$rs1=mysql_query($sql,$this->Dblink);	
...
$rs2=mysql_query($sql2,$this->Dblink);	
...
$rs3=mysql_query($sql3,$this->Dblink);	
$first=true;
$comma='';
...
$rs4=mysql_query($sql4,$this->Dblink);
...
/**
 * DBMysql::Download() Download Sql File.......
...
/**
 * DBMysql::redirect() function To Redirect
...
/**
 * DBMysql::generateKey()  function to genrate key
 * @return string   
 */
...
/**
 * DBMysql::randomkey() function To get randomkey
...
$key.=$pattern{rand(0,44)};
 ...
 /**
 * DBMysql::ShowIP() get Real IP Adress
 * @return string 
 */ 
...
/**
 *  DBMysql::newEmail() Send Mail by Mail Function...
...
/**
 * DBMysql::File_extension()    function get File Exetention.......
